...
# Approximated minimum for N_data = 100, reg_param = 0
x_min = np.array([ 2.299241471210803  ,  1.202442682318337  , -1.1325697935492847 ,
       -1.1675561940070192 ,  0.19089098319140987,  0.3393676507742121 ,
       -2.153402657184347  ,  0.9339360965753712 , -0.755369764492206  ,
        1.138386375797239  , -0.4502736371390507 , -0.7752352269168057 ,
        0.6513458120307846 ,  1.0411512066616344 , -1.8553070056544718 ,
       -1.2007674809533602 ,  1.8839374285414212 ])
...
ax4.set_xlabel('$j$')
ax4.set_yticks(np.arange(0,np.ceil(np.max(numsample_arr))+1,step=4))
