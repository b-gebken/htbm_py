...
x_min = np.array([-1.3743387278747687e+00, -5.9484050281642631e-01,
        7.6870344496465237e-14,  4.9559593540190500e-01,
        6.5435957971715486e-01, -3.7823750424734771e-13,
       -1.1896022888980822e+00,  1.2492000843092101e+00,
        2.4419934139672178e-13, -6.8033237722062201e-01,
        1.4004837302346820e-11, -2.3234153515091548e-13,
        1.5701178647420390e-11,  1.1005040966214477e+00,
       -2.4388023876258726e+00, -1.7808364881162004e+00,
        1.9150885074842401e+00])
...
ax4.set_xlabel('$j$')
ax4.set_yticks(np.arange(0,np.ceil(np.max(numsample_arr))+1,step=3))
...
if SAVE_PLOT:
    plt.savefig('experiments/experiment_2/plot_1.png',bbox_inches='tight',dpi=300)
else:
    plt.show()