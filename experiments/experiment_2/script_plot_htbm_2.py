...
x_min = np.array([-1.3728452334636907e+00, -5.9443581594058303e-01,
        1.5153061585111993e-03,  4.9505737111301207e-01,
        6.5347734311156780e-01,  3.7036060403370674e-03,
       -1.1931753633445930e+00,  1.2544647249513254e+00,
        9.4365172298928248e-04, -6.7545359164485974e-01,
       -5.0440232479003512e-03, -8.2083465318125127e-04,
       -1.0842241876345515e-03,  1.0971708548258978e+00,
       -2.4374192409241302e+00, -1.7898657383727536e+00,
        1.9150885074842408e+00])
...
print('x^best: ',repr(result_local_method['best_x']))
...
if SAVE_PLOT:
    plt.savefig('experiments/experiment_2/plot_2_1.png',bbox_inches='tight',dpi=300)
else:
    plt.show()